...
const provisionalTestEmail = "io.marketin.09@gmail.com";
const guidedEmailUrl = `mailto:${provisionalTestEmail}?subject=Prueba%20de%20recepci%C3%B3n%20%E2%80%94%20Firma%20Bordados&body=Prueba%20de%20recepci%C3%B3n%20del%20staging.%0A%0ATipo%20de%20prenda%3A%0AT%C3%A9cnica%20que%20me%20interesa%20%28bordado%20o%20serigraf%C3%ADa%29%3A%0ACantidad%20aproximada%3A%0AUso%20o%20requerimiento%3A`;
...
export default function Home() {
  ...
  function handleContact(event: FormEvent<HTMLFormElement>) {
    ...
    window.location.href = `mailto:${provisionalTestEmail}?subject=${subject}&body=${body}`;
  }
      ...
      <main id="contenido-principal" ref={mainRef} tabIndex={-1}>
        ...
        <section id="solicitar" className="relative overflow-hidden bg-[#fff7da] py-20 lg:py-28">
          ...
          <div className="relative mx-auto max-w-[1440px] px-5 lg:px-10">
            ...
            <div data-reveal data-reveal-delay="2" className="mt-8 grid gap-5 rounded-2xl bg-[#0d4c9e] p-6 text-white shadow-[0_18px_34px_rgba(18,61,128,0.2)] lg:grid-cols-[1fr_auto] lg:items-center lg:p-8"><div><p className="text-[0.65rem] font-bold uppercase tracking-[0.16em] text-[#ffe584]">Prueba temporal de correo</p><p className="mt-2 max-w-2xl text-sm leading-6 text-white/84">Para verificar la recepción en staging, este botón prepara un correo de prueba a un buzón provisional. No envíe datos reales; el sitio no guarda esta información.</p></div><a href={guidedEmailUrl} className="motion-cta inline-flex items-center justify-center gap-3 rounded-md bg-[#df2b2c] px-6 py-4 text-xs font-bold uppercase tracking-[0.13em] text-white transition-all hover:-translate-y-0.5 hover:bg-[#c82021]">Preparar prueba <Mail size={17} /></a></div>
