      ...
      <main id="contenido-principal" ref={mainRef} tabIndex={-1}>
        ...
        <section id="capacidades" className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
            ...
            <div data-reveal data-reveal-delay="4" className="mt-7 grid max-w-4xl gap-3 sm:grid-cols-2">
        ...
        <section id="acerca" className="bg-[#f2f7ff] py-20 lg:py-28">
          <div className="mx-auto grid max-w-[1440px] gap-10 px-5 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-10">
            ...
            <div data-reveal data-reveal-delay="1" className="order-1 lg:order-2"><SectionLabel number="02" label="Nuestro trabajo" /><h2 className="mt-5 font-display text-4xl font-bold leading-tight tracking-[-0.04em] text-[#123d80] sm:text-5xl">Prendas que hacen visible una buena organización.</h2><p className="mt-6 text-lg leading-8 text-[#5d6c82]">La selección adecuada de prenda, nombre y bordado puede ayudar a que cada equipo se vea cuidado, consistente y listo para representar a su organización.</p><p className="mt-4 max-w-xl text-sm leading-6 text-[#65728a]">Consulte playeras, camisas, uniformes industriales y línea médica para encontrar una opción adecuada para su equipo.</p><div className="mt-6 flex items-center gap-3"><StitchRule /><span className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-[#6d7c92]">Ficha de proceso · 02</span></div><a href="#contacto" className="motion-cta mt-8 inline-flex items-center gap-2 border-b-2 border-[#df2b2c] pb-2 text-xs font-bold uppercase tracking-[0.13em] text-[#123d80] transition-colors hover:text-[#df2b2c]">Hablemos de su requerimiento <ArrowUpRight size={16} /></a></div>
          </div>
        </section>
