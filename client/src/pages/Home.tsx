...
const galleryEmbroideryImage = "https://firmabordado-awa6sfhz.manus.space/manus-storage/firma-bordados-galeria-bordado_59f1f5d0.png";
const galleryScreenprintImage = "https://firmabordado-awa6sfhz.manus.space/manus-storage/firma-bordados-galeria-serigrafia_ac9fe990.png";
...
export default function Home() {
  ...
  function handleContact(event: FormEvent<HTMLFormElement>) {
    ...
    const subject = encodeURIComponent(`Solicitud de información${company ? ` — ${company}` : ""}`);
    const body = encodeURIComponent(`Nombre: ${name}\nEmpresa: ${company}\n\nSolicitud:\n${message}`);
    setFormNotice("Se abrirá su aplicación de correo para enviar la solicitud.");
    window.location.href = `mailto:firmabordados@yahoo.com?subject=${subject}&body=${body}`;
  }
