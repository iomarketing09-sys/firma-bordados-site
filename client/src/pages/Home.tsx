      ...
      <main id="contenido-principal" ref={mainRef} tabIndex={-1}>
        ...
        <section id="acerca" className="bg-[#f2f7ff] py-20 lg:py-28">
          <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
            ...
            <div data-reveal data-reveal-delay="2" className="mt-14 border-t border-[#cbd8eb] pt-9"><div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><p className="text-[0.65rem] font-bold uppercase tracking-[0.16em] text-[#df2b2c]">Galería de proceso</p><h3 className="mt-2 font-display text-3xl font-bold tracking-[-0.035em] text-[#123d80]">Detalles que acompañan a cada prenda.</h3></div><p className="max-w-sm text-sm leading-6 text-[#65728a]">Una muestra visual de bordado, detalle de proceso y variedad de prendas para conversar sobre su requerimiento.</p></div><div className="mt-7 grid gap-4 md:grid-cols-3"><figure className="group overflow-hidden rounded-2xl bg-white shadow-[0_12px_24px_rgba(18,61,128,0.1)]"><img src={authorizedProcessImage} alt="Detalle de un bordado en una prenda" loading="lazy" decoding="async" className="h-[300px] w-full object-cover object-[50%_25%] transition-transform duration-500 group-hover:scale-[1.03]" /><figcaption className="border-t-4 border-[#0d4c9e] px-5 py-4 text-[0.66rem] font-bold uppercase tracking-[0.13em] text-[#31517e]">Bordado en prenda</figcaption></figure><figure className="group overflow-hidden rounded-2xl bg-white shadow-[0_12px_24px_rgba(18,61,128,0.1)]"><img src={processImage} alt="Detalle de bordado y maquinaria" loading="lazy" decoding="async" className="h-[300px] w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" /><figcaption className="border-t-4 border-[#f3bd25] px-5 py-4 text-[0.66rem] font-bold uppercase tracking-[0.13em] text-[#31517e]">Detalle de bordado</figcaption></figure><figure className="group overflow-hidden rounded-2xl bg-white shadow-[0_12px_24px_rgba(18,61,128,0.1)]"><img src={uniformsImage} alt="Playeras y camisas en distintos colores" loading="lazy" decoding="async" className="h-[300px] w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" /><figcaption className="border-t-4 border-[#df2b2c] px-5 py-4 text-[0.66rem] font-bold uppercase tracking-[0.13em] text-[#31517e]">Variedad de prendas</figcaption></figure></div></div>
          </div>
        </section>
