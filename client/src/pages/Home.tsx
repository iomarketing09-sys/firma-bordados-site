        ...
        <section id="inicio" className="relative overflow-hidden bg-[#fffdf7] pt-[84px]">
          ...
          <div className="relative mx-auto grid max-w-[1440px] gap-8 px-5 py-12 lg:grid-cols-[0.87fr_1.13fr] lg:items-stretch lg:px-10 lg:py-16">
            ...
            <div data-reveal data-reveal-delay="1" className="relative min-h-[410px] overflow-hidden rounded-[1.5rem] bg-[#0d4c9e] shadow-[0_24px_48px_rgba(18,61,128,0.18)] lg:min-h-[570px]">
              <img src={heroImage} alt="Proceso de bordado industrial y prendas de trabajo" className="h-full w-full object-cover object-[67%_center] brightness-110 saturate-[1.08]" />
        ...
        <section id="capacidades" className="bg-white py-20 lg:py-28">
          <div className="mx-auto max-w-[1440px] px-5 lg:px-10">
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              ...
              <Capability number="03" revealDelay="3" icon={<Layers3 />} title="Serigrafía" text="Una alternativa de impresión para identificar y personalizar prendas." color="border-t-[#df2b2c]" badge="bg-[#f9d1d1] text-[#bd2021]" />
            ...
            <p data-reveal data-reveal-delay="4" className="mt-7 max-w-2xl border-l-2 border-[#df2b2c] pl-4 text-sm leading-6 text-[#65728a]">Para mantener una atención clara desde el inicio: no trabajamos parches ni gorras.</p>
          </div>
        </section>

        <section id="acerca" className="bg-[#f2f7ff] py-20 lg:py-28">
          <div className="mx-auto grid max-w-[1440px] gap-10 px-5 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-10">
            <div data-reveal className="relative order-2 grid grid-cols-[1.05fr_0.95fr] gap-3 sm:gap-5 lg:order-1"><div className="overflow-hidden rounded-2xl bg-[#0d4c9e] shadow-[0_16px_34px_rgba(13,76,158,0.14)]"><img src={authorizedProcessImage} alt="Prenda con bordado en proceso" className="h-full min-h-[280px] w-full object-cover object-[50%_18%]" /></div><div className="flex flex-col gap-3 sm:gap-5"><div className="min-h-[140px] rounded-2xl bg-[#f3bd25] p-5 text-[#123d80]"><p className="font-display text-3xl font-bold">20+</p><p className="mt-1 text-xs font-bold uppercase tracking-[0.12em]">años de experiencia</p><StitchRule className="mt-4 text-[#123d80]" /></div><div className="overflow-hidden rounded-2xl"><img src={processImage} alt="Detalle de bordado y maquinaria" className="h-[205px] w-full object-cover" /></div></div><div className="absolute -bottom-3 -left-3 h-16 w-16 rounded-full bg-[#df2b2c] sm:h-20 sm:w-20" /></div>
            <div data-reveal data-reveal-delay="1" className="order-1 lg:order-2"><SectionLabel number="02" label="Nuestro trabajo" /><h2 className="mt-5 font-display text-4xl font-bold leading-tight tracking-[-0.04em] text-[#123d80] sm:text-5xl">Prendas que hacen visible una buena organización.</h2><p className="mt-6 text-lg leading-8 text-[#5d6c82]">La selección adecuada de prenda, nombre y bordado puede ayudar a que cada equipo se vea cuidado, consistente y listo para representar a su organización.</p><div className="mt-6 flex items-center gap-3"><StitchRule /><span className="text-[0.62rem] font-bold uppercase tracking-[0.16em] text-[#6d7c92]">Ficha de proceso · 02</span></div><a href="#contacto" className="motion-cta mt-8 inline-flex items-center gap-2 border-b-2 border-[#df2b2c] pb-2 text-xs font-bold uppercase tracking-[0.13em] text-[#123d80] transition-colors hover:text-[#df2b2c]">Hablemos de su requerimiento <ArrowUpRight size={16} /></a></div>
          </div>
        </section>
